 ...
 * @version 2020-04-29
 */
@Table(name="zb_device_seal_item", alias="a", columns={
		@Column(name="id", attrName="id", label="主键Id", isPK=true),
		@Column(name="seal_id", attrName="sealId.id", label="主表Id"),
...
public class ZbDeviceSealItem extends DataEntity<ZbDeviceSealItem> {
	
	private static final long serialVersionUID = 1L;
	private ZbDeviceSeal sealId;		// 主表Id 父类
	...
	public ZbDeviceSealItem() {
		this(null);
	}


	public ZbDeviceSealItem(ZbDeviceSeal sealId){
		this.sealId = sealId;
	}
	
	@NotBlank(message="主表Id不能为空")
	@Length(min=0, max=64, message="主表Id长度不能超过 64 个字符")
	public ZbDeviceSeal getSealId() {
		return sealId;
	}

	public void setSealId(ZbDeviceSeal sealId) {
		this.sealId = sealId;
	}
